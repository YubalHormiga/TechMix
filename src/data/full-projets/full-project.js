export const fullProjects = [
  ...
  },
  {
    ...
    github:
      'https://github.com/YubalHormiga/TechMix/tree/main/src/modules/full-projects/InventoryManager',
    description:
      'Saborify es una aplicación en desarrollo que busca revolucionar la forma en que exploras y gestionas recetas. Con la API de Spoonacular, permitirá buscar platos, calcular valores nutricionales y organizar tus favoritos de forma sencilla. Diseñada para ser intuitiva y visualmente atractiva, Saborify está en construcción, enfocándose en crear una experiencia culinaria única. ¡Pronto disponible!',
    difficulty: 'easy'
  }
]
